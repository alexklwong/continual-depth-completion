...
class network(nn.Module):
    def __init__(self, in_layers_image=3, in_layers_depth=1):
        ...
        self.rgb_encoder = RGBEncoder(in_layers_image, cenc_layers, 3)

        self.depth_encoder1 = DepthEncoder(in_layers_depth, denc_layers, 3)
        self.depth_decoder1 = DepthDecoder(ddcd_layers, 3)

        self.depth_encoder2 = DepthEncoder(in_layers_depth + 1, denc_layers, 3)
        self.depth_decoder2 = DepthDecoder(ddcd_layers, 3)

        self.depth_encoder3 = DepthEncoder(in_layers_depth + 1, denc_layers, 3)
