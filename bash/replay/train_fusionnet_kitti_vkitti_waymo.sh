...
--max_evaluate_depth 100.0 100.0 80.0 \
--evaluation_protocols kitti vkitti waymo \
--n_step_per_summary 5000 \
--n_step_per_checkpoint 5000 \
--start_step_validation 5000 \
--restore_paths \
--frozen_model_paths \
--checkpoint_path trained_completion/replay/fusionnet_kitti_vkitti_waymo \
--device gpu \
--n_thread 8
