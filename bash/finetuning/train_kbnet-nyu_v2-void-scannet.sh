...
--checkpoint_path trained_completion/finetune/kbnet/kbnet-nyu_v2-void \
--device gpu \
--n_thread 4

best_step_void=$(extract_last_best_step "trained_completion/finetune/kbnet/kbnet-nyu_v2-void/results.txt")
...
--start_step_validation 5000 \
--restore_paths \
    trained_completion/finetune/kbnet/kbnet-nyu_v2-void/checkpoints_kbnet-$best_step_void/kbnet-$best_step_void.pth \
    trained_completion/finetune/kbnet/kbnet-nyu_v2-void/checkpoints_kbnet-$best_step_void/posenet-$best_step_void.pth \
--frozen_model_paths \

--checkpoint_path \
    trained_completion/finetune/kbnet/kbnet-nyu_v2-void-scannet \
--device gpu \
--n_thread 4
