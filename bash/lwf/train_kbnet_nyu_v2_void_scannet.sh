...
--train_image_paths training/scannet/scannet_train_image.txt \
--train_sparse_depth_path training/scannet/scannet_train_sparse_depth.txt \
--train_intrinsics_path training/scannet/scannet_train_intrinsics.txt \
--val_image_paths \
    testing/nyu/nyu_test_image.txt \
    testing/v2/v2_test_image.txt \
    testing/void/void_test_image.txt \
    testing/scannet/scannet_test_image.txt \
--val_sparse_depth_paths \
    testing/nyu/nyu_test_sparse_depth.txt \
    testing/v2/v2_test_sparse_depth.txt \
    testing/void/void_test_sparse_depth.txt \
    testing/scannet/scannet_test_sparse_depth.txt \
--val_intrinsics_paths \
    testing/nyu/nyu_test_intrinsics.txt \
    testing/v2/v2_test_intrinsics.txt \
    testing/void/void_test_intrinsics.txt \
    testing/scannet/scannet_test_intrinsics.txt \
--val_ground_truth_paths \
    testing/nyu/nyu_test_ground_truth.txt \
    testing/v2/v2_test_ground_truth.txt \
...
--w_losses \
    ...
    w_lwf=1.0 \
--min_evaluate_depth 0.2 0.2 0.2 0.2 \
--max_evaluate_depth 5.0 5.0 5.0 5.0 \
--evaluation_protocols nyu_v2 v2 void scannet \
--n_step_per_summary 5000 \
--n_step_per_checkpoint 5000 \
--start_step_validation 5000 \
--checkpoint_path trained_completion/lwf/kbnet_nyu_v2_void_scannet \
--device gpu \
--n_thread 8 \
--restore_paths \
--frozen_model_paths \
