...
--model_name fusionnet-indoor \
--network_modules depth pose initialize_scaffnet spatial_pyramid_pool \
--min_predict_depth 0.1 \
--max_predict_depth 8.0 \
--train_batch_size 12 \
--train_crop_shapes 416 576 \
--learning_rates 5e-5 2.5e-5 1.25e-5 \
...
--checkpoint_path \
    trained_models/depth_completion/base_model/fusionnet/fusionnet-nyu_v2 \
--restore_paths \
