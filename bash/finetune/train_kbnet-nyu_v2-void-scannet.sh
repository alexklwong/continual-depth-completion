...
--restore_paths \
    pretrained_models_uncle/depth_completion/kbnet/nyu_v2/kbnet-nyu_v2.pth \
    pretrained_models_uncle/depth_completion/kbnet/nyu_v2/posenet-nyu_v2.pth \
--checkpoint_path \
    trained_models/depth_completion/finetune/kbnet/kbnet-nyu_v2-void \
--device gpu \
--n_thread 4

best_step_void=$(extract_last_best_step "trained_models/depth_completion/finetune/kbnet/kbnet-nyu_v2-void/results.txt")
...
--start_step_validation 5000 \
--restore_paths \
    trained_models/depth_completion/finetune/kbnet/kbnet-nyu_v2-void/checkpoints_kbnet_indoor-$best_step_void/kbnet-$best_step_void.pth \
    trained_models/depth_completion/finetune/kbnet/kbnet-nyu_v2-void/checkpoints_kbnet_indoor-$best_step_void/posenet-$best_step_void.pth \
--checkpoint_path \
    trained_models/depth_completion/finetune/kbnet/kbnet-nyu_v2-void-scannet \
--device gpu \
--n_thread 4
