...
--restore_paths \
    ...
    pretrained_models_uncle/depth_completion/voiced/nyu_v2/posenet-nyu_v2.pth \
--checkpoint_path \
    trained_models/depth_completion/finetune/voiced/voiced-nyu_v2-void \
--device gpu \
--n_thread 4

best_step_void=$(extract_last_best_step "trained_models/depth_completion/finetune/voiced/voiced-nyu_v2-void/results.txt")
...
--checkpoint_path \
    trained_models/depth_completion/finetune/voiced/voiced-nyu_v2-void-scannet \
--device gpu \
--n_thread 4
