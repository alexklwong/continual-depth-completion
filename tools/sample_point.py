...
def sample_and_save(sparse_depth_path):
    ...
    valid_points, sparse_depth = calculate_valid_points(sparse_depth_path)
        ...
        print(f"Found {valid_points} points, sampling to 1500")
        ...
        # verify
        print(f"Proofed, {valid_points_after_save} points")
        
    else:
        print(f"Ignored: {sparse_depth_path}, Found {valid_points} points")
