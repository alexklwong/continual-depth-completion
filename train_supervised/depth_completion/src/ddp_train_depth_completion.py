...
parser.add_argument('--train_image_paths',
    nargs='+', type=str, required=True, help='List of paths to list of training image paths')
parser.add_argument('--train_sparse_depth_paths',
    nargs='+', type=str, required=True, help='List of paths to list of training sparse depth paths')
parser.add_argument('--train_ground_truth_paths',
    nargs='+', type=str, required=True, help='List of paths to list of training ground truth paths')
parser.add_argument('--train_intrinsics_paths',
    nargs='+', type=str, default=[], help='PList of paths to list of training intrinsics paths')
...
parser.add_argument('--lr_warmup_iter',
    type=int, default=-1, help='The number of iterations to warmup')
...
parser.add_argument('--w_losses',
    nargs='+', type=str, action=ParseStrFloatKeyValueAction, help='Weight of each loss term as key-value pairs: w_smoothness=2.00')
...
parser.add_argument('--port',
    type=int, default=56789, help='DDP port for communicating gradients')
