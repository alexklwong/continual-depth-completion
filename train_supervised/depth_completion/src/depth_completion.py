...
def train(train_image_paths,
    ...
    model_checkpoint_path = os.path.join(checkpoint_path, 'checkpoints', '{}'.format(model_name[0]) + '-{}.pth')
    ...
    for epoch in range(1, n_epoch + 1):
        ...
        for inputs in train_dataloader:
            ...
            pbar.set_description('tb path: {} / train {}/{}'.format(event_base_path, epoch, learning_schedule[-1]))
            pbar.update(1)
