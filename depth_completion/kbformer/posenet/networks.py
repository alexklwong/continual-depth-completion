...
class KBNetEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        activation_func = posenet_utils.activation_func(activation_func)
        ...
        if n in resolutions_backprojection:
            ...
            self.conv0_image = posenet_utils.Conv2d(
            ...
            self.conv0_depth = posenet_utils.Conv2d(
            ...
            self.calibrated_backprojection1 = posenet_utils.CalibratedBackprojectionBlock(
            ...
            self.conv1_image = posenet_utils.VGGNetBlock(
                in_channels=input_channels_image,
                out_channels=n_filters_image[n],
            ...
            self.conv1_depth = posenet_utils.VGGNetBlock(
                in_channels=input_channels_depth,
                out_channels=n_filters_depth[n],
        ...
        if n in resolutions_backprojection:
            ...
            self.calibrated_backprojection2 = posenet_utils.CalibratedBackprojectionBlock(
                in_channels_image=in_channels_image,
                in_channels_depth=in_channels_depth,
                in_channels_fused=in_channels_fused,
                n_filter_image=n_filters_image[n],
            ...
            self.conv2_image = posenet_utils.VGGNetBlock(
            ...
            self.conv2_depth = posenet_utils.VGGNetBlock(
        ...
        if n in resolutions_backprojection:
            ...
            self.calibrated_backprojection3 = posenet_utils.CalibratedBackprojectionBlock(
                in_channels_image=in_channels_image,
                in_channels_depth=in_channels_depth,
                in_channels_fused=in_channels_fused,
                n_filter_image=n_filters_image[n],
            ...
            self.conv3_image = posenet_utils.VGGNetBlock(
                in_channels=in_channels_image,
                out_channels=n_filters_image[n],
                n_convolution=n_convolutions_image[n],
                stride=2,
            ...
            self.conv3_depth = posenet_utils.VGGNetBlock(
                in_channels=in_channels_depth,
                out_channels=n_filters_depth[n],
                n_convolution=n_convolutions_depth[n],
                stride=2,
        ...
        if n in resolutions_backprojection:
            ...
            self.calibrated_backprojection4 = posenet_utils.CalibratedBackprojectionBlock(
                in_channels_image=in_channels_image,
                in_channels_depth=in_channels_depth,
                in_channels_fused=in_channels_fused,
                n_filter_image=n_filters_image[n],
            ...
            self.conv4_image = posenet_utils.VGGNetBlock(
                in_channels=in_channels_image,
                out_channels=n_filters_image[n],
                n_convolution=n_convolutions_image[n],
                stride=2,
            ...
            self.conv4_depth = posenet_utils.VGGNetBlock(
                in_channels=in_channels_depth,
                out_channels=n_filters_depth[n],
                n_convolution=n_convolutions_depth[n],
                stride=2,
        ...
        if n in resolutions_backprojection:
            ...
            self.calibrated_backprojection5 = posenet_utils.CalibratedBackprojectionBlock(
                in_channels_image=in_channels_image,
                in_channels_depth=in_channels_depth,
                in_channels_fused=in_channels_fused,
                n_filter_image=n_filters_image[n],
            ...
            self.conv5_image = posenet_utils.VGGNetBlock(
                in_channels=in_channels_image,
                out_channels=n_filters_image[n],
                n_convolution=n_convolutions_image[n],
                stride=2,
            ...
            self.conv5_depth = posenet_utils.VGGNetBlock(
                in_channels=in_channels_depth,
                out_channels=n_filters_depth[n],
                n_convolution=n_convolutions_depth[n],
                stride=2,
...
class PoseEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = posenet_utils.Conv2d(
            input_channels,
            n_filters[0],
            kernel_size=7,
            stride=2,
        ...
        self.conv2 = posenet_utils.Conv2d(
            n_filters[0],
            n_filters[1],
            kernel_size=5,
            stride=2,
        ...
        self.conv3 = posenet_utils.Conv2d(
            n_filters[1],
            n_filters[2],
            kernel_size=3,
            stride=2,
        ...
        self.conv4 = posenet_utils.Conv2d(
            n_filters[2],
            n_filters[3],
            kernel_size=3,
            stride=2,
        ...
        self.conv5 = posenet_utils.Conv2d(
            n_filters[3],
            n_filters[4],
            kernel_size=3,
            stride=2,
        ...
        self.conv6 = posenet_utils.Conv2d(
            n_filters[4],
            n_filters[5],
            kernel_size=3,
            stride=2,
        ...
        self.conv7 = posenet_utils.Conv2d(
            n_filters[5],
            n_filters[6],
            kernel_size=3,
            stride=2,
...
class ResNetEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if n_layer == 18:
            n_blocks = [2, 2, 2, 2]
            resnet_block = posenet_utils.ResNetBlock
        elif n_layer == 34:
            n_blocks = [3, 4, 6, 3]
            resnet_block = posenet_utils.ResNetBlock
        elif n_layer == 50:
            n_blocks = [3, 4, 6, 3]
            use_bottleneck = True
            resnet_block = posenet_utils.ResNetBottleneckBlock
        else:
...
class AtrousResNetEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if n_layer == 18:
            n_blocks = [2, 2, 2, 2]
            resnet_block = posenet_utils.ResNetBlock
            atrous_resnet_block = posenet_utils.AtrousResNetBlock
        elif n_layer == 34:
            n_blocks = [3, 4, 6, 3]
            resnet_block = posenet_utils.ResNetBlock
            atrous_resnet_block = posenet_utils.AtrousResNetBlock
        ...
        if atrous_spatial_pyramid_pool_dilations is not None:
            self.atrous_spatial_pyramid_pool = posenet_utils.AtrousSpatialPyramidPooling(
                in_channels,
                out_channels,
...
class VGGNetEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.conv2 = posenet_utils.VGGNetBlock(
            in_channels,
            out_channels,
        ...
        self.conv3 = posenet_utils.VGGNetBlock(
            in_channels,
            out_channels,
            n_convolution=n_convolutions[block_idx],
            stride=2,
        ...
        self.conv4 = posenet_utils.VGGNetBlock(
            in_channels,
            out_channels,
            n_convolution=n_convolutions[block_idx],
            stride=2,
        ...
        self.conv5 = posenet_utils.VGGNetBlock(
            in_channels,
            out_channels,
            n_convolution=n_convolutions[block_idx],
            stride=2,
        ...
        if filter_idx < len(n_filters):
            ...
            self.conv6 = posenet_utils.VGGNetBlock(
                in_channels,
                out_channels,
                n_convolution=n_convolutions[block_idx],
                stride=2,
        ...
        if filter_idx < len(n_filters):
            ...
            self.conv7 = posenet_utils.VGGNetBlock(
                in_channels,
                out_channels,
                n_convolution=n_convolutions[block_idx],
                stride=2,
...
class AtrousVGGNetEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        # Resolution 1/8 with 2x dilation
        in_channels, out_channels = [n_filters[2], n_filters[3]]
        self.conv4 = posenet_utils.AtrousVGGNetBlock(
            in_channels,
            out_channels,
        ...
        # Resolution 1/8 with 4x dilation
        in_channels, out_channels = [n_filters[3], n_filters[4]]
        self.conv5 = posenet_utils.AtrousVGGNetBlock(
            in_channels,
            out_channels,
...
class MultiScaleDecoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        activation_func = posenet_utils.activation_func(activation_func)
        output_func = posenet_utils.activation_func(output_func)
        ...
        if network_depth > 6:
            self.deconv6 = posenet_utils.DecoderBlock(
                in_channels,
                skip_channels,
                out_channels,
                weight_initializer=weight_initializer,
        ...
        if network_depth > 5:
            self.deconv5 = posenet_utils.DecoderBlock(
                in_channels,
                skip_channels,
                out_channels,
                weight_initializer=weight_initializer,
        ...
        if network_depth > 4:
            self.deconv4 = posenet_utils.DecoderBlock(
                in_channels,
                skip_channels,
                out_channels,
                weight_initializer=weight_initializer,
        ...
        # Resolution 1/16 -> 1/8
        if network_depth > 3:
            self.deconv3 = posenet_utils.DecoderBlock(
                in_channels,
                skip_channels,
                out_channels,
                weight_initializer=weight_initializer,
            ...
            if self.n_resolution > 3:
                self.output3 = posenet_utils.Conv2d(
                    out_channels,
                    output_channels,
                    kernel_size=3,
                    stride=1,
        ...
        if network_depth > 2:
            self.deconv2 = posenet_utils.DecoderBlock(
                in_channels,
                skip_channels,
                out_channels,
                weight_initializer=weight_initializer,
            ...
            if self.n_resolution > 2:
                self.output2 = posenet_utils.Conv2d(
                    out_channels,
                    output_channels,
                    kernel_size=3,
                    stride=1,
        ...
        self.deconv1 = posenet_utils.DecoderBlock(
            in_channels,
            skip_channels,
            out_channels,
            weight_initializer=weight_initializer,
        ...
        if self.n_resolution > 1:
            self.output1 = posenet_utils.Conv2d(
                out_channels,
                output_channels,
                kernel_size=3,
                stride=1,
        ...
        self.deconv0 = posenet_utils.DecoderBlock(
            in_channels,
            skip_channels,
            out_channels,
            weight_initializer=weight_initializer,
        ...
        self.output0 = posenet_utils.Conv2d(
            out_channels,
            output_channels,
            kernel_size=3,
            stride=1,
...
class PoseDecoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if len(n_filters) > 0:
            ...
            self.conv = posenet_utils.Conv2d(
                in_channels=input_channels,
                out_channels=6,
                kernel_size=1,
                stride=1,
    ...
    def forward(self, x):
        '''
        Forward latent vector x through pose decoder

        Arg(s):
            x : torch.Tensor[float32]
                latent vector
        Returns:
            torch.Tensor[float32] : 6 DoF motion
        '''

        conv_output = self.conv(x)
        pose_mean = torch.mean(conv_output, [2, 3])
        dof = 0.01 * pose_mean
        posemat = posenet_utils.pose_matrix(
            dof,
