...
--restore_paths \
    trained_completion/kbnet/nyu_pretrained7/checkpoints_kbnet_nyu_v2-370000/kbnet-370000.pth \
    trained_completion/kbnet/nyu_pretrained7/checkpoints_kbnet_nyu_v2-370000/posenet-370000.pth \
--checkpoint_path \
    trained_completion/kbnet/kbnet_nyu_fisher \
--device gpu \
--n_thread 8
