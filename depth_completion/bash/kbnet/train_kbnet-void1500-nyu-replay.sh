...
--train_crop_shapes \
    416 576 \
--replay_batch_size 6 \
--replay_crop_shapes 416 512 \
--replay_dataset_size 2048 \
...
--checkpoint_path \
trained_completion/kbnet/nyu_v2/void_nyu_replay4 \
--restore_paths \
    /media/home/alwong/workspace/continual-depth-completion/pretrained_models/depth_completion/kbnet/void/kbnet-void1500-new.pth \
    /media/home/alwong/workspace/continual-depth-completion/pretrained_models/depth_completion/kbnet/void/posenet-void1500-new.pth \
--device gpu \
--n_thread 8
